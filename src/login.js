...
class Login extends Component {
    ...
    goLogin=()=>
    {
        if((this.state.email=="admin@gmail.com") && (this.state.pass=="123"))
        {
            ...
            localStorage.setItem("userid","9518539757");
                        ...
                        <div className="card">
                            ...
                            <div className="card-body">
                                <div className="form-group">
                                    ...
                                    <input type="text" onChange={this.processEmail} className="form-control" />
                                </div>
                                <div className="form-group">
                                    <label>Password</label>
                                    <input type="password" onChange={this.processPass} className="form-control" />
                                </div>
                            </div>
